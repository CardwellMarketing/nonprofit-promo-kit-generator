...
function buildPromoKit(d) {
  ...
  return [
    ...
    },
    {
      ...
      text: `Welcome everyone, and thank you for joining ${d.title}.\n\nToday, we are focusing on ${d.topic}. We are honored to be joined by ${d.speakers}, who bring valuable perspective for ${d.audience}.\n\nPlease join me in welcoming our speaker(s).`
    }
  ];
}
